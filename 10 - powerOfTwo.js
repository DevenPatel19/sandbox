...
it has only one bit set to 1, which is the leftmost bit (the most significant bit).
...
Bitwise AND Operation (4 & 3): Now, let's perform a bitwise AND operation between the original number 
4 and the result of subtracting 1 (which is 3).
...
Result: 4 & 3 = 0: The result of the bitwise AND operation between 4 and 3 is 0. This means that the
 binary representation of the result has only zeroes, indicating that 4 is indeed a power of two.


And

Number: 3 (binary: 0011) - This is the binary representation of the number 3. In binary, it has two 
bits set to 1. These are the rightmost bit and the second rightmost bit.
...
Notice that subtracting 1 from 3 sets the rightmost bit (the least significant bit) to 0 and leaves 
the other bits unchanged.

Bitwise AND Operation (3 & 2): Now, let's perform a bitwise AND operation between the original 
number 3 and the result of subtracting 1 (which is 2).
...
Result: 3 & 2 = 2: The result of the bitwise AND operation between 3 and 2 is 2. This means that the
 binary representation of the result has one bit set to 1, which is the second rightmost bit.
  */